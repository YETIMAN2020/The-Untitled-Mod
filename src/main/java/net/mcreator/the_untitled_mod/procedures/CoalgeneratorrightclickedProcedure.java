...
public class CoalgeneratorrightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		if (entity == null)
			return;
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == TheUntitledModModItems.ENERGYMETER
				.get()) {
			if (entity instanceof Player _player && !_player.level.isClientSide())
				...
				.getItem() == TheUntitledModModItems.ENERGYMETER.get()) {
			if (entity instanceof Player _player && !_player.level.isClientSide())
