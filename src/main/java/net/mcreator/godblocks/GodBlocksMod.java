 ...
 *
 */
package net.mcreator.godblocks;
...
@Mod("god_blocks")
public class GodBlocksMod {
	public static final Logger LOGGER = LogManager.getLogger(GodBlocksMod.class);
	public static final String MODID = "god_blocks";
